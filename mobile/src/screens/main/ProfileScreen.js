...
export default function ProfileScreen({ onSignOut }) {
  ...
  const scoreColor = currentUser.trustScore >= 80 ? '#16a34a' : '#d97706';
      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 14 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.stats}>
          <View style={styles.stat}>
            <Text style={[styles.statVal, { color: scoreColor }]}>{currentUser.trustScore}%</Text>
        ...
        <View style={styles.section}>
          ...
          {[
            ...
            { label: 'Network', value: currentUser.network },
            { label: 'Email', value: 'kwame.asante@email.com' },
        ...
        <View style={styles.section}>
          ...
          {[
            ...
            { label: '👆 Biometric Auth', value: currentUser.biometricEnabled ? 'Enabled' : 'Disabled', color: currentUser.biometricEnabled ? '#16a34a' : '#dc2626' },
        ...
        <View style={styles.researchCard}>
          ...
          <Text style={styles.researchText}>
            This mobile app is part of a research project investigating AI, blockchain, and MFA-based fraud prevention for Ghana's mobile money ecosystem (Telecel Cash). All data is simulated for academic demonstration.
          </Text>
          <View style={styles.researchTags}>
            <View style={styles.tag}><Text style={styles.tagText}>University of Ghana</Text></View>
            <View style={styles.tag}><Text style={styles.tagText}>Telecel Cash</Text></View>
            <View style={styles.tag}><Text style={styles.tagText}>2025</Text></View>
          </View>
        </View>
