...
router.get('/analytics', authenticate, requireAdmin, async (req, res) => {
  // Daily transaction counts and average risk for the last 30 days
  ...
  // Per-category breakdown (maps to the admin dashboard pie / bar chart)
  ...
  // Most common risk reasons across all flagged transactions
